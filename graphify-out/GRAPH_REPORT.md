...
Cohesion: 0.04
Nodes (31): _(), _clearLiveRegion(), compositionend(), compositionupdate(), _equalEvents(), _finalizeComposition(), flush(), get() (+23 more)
...
Cohesion: 0.11
Nodes (16): btnCustomMenu, customCommandsGrid, customPopupBackdrop, customShortcutsPopup, filteredSlashCommands, handleImageFile(), handlePasteEvent(), initSlashMenu() (+8 more)
...
Cohesion: 0.07
Nodes (6): _cancelCallback(), charProperties(), n(), r(), _requestCallback(), warn()

### Community 15 - "Community 15"
Cohesion: 0.21
Nodes (17): clearAttachment(), clearPromptInput(), closeCustomPopup(), closeSlashPalette(), getPromptText(), handleMicOrSendClick(), selectSlashCommand(), sendKey() (+9 more)
...
Cohesion: 0.07
Nodes (19): addEncoding(), addProtocol(), addRefreshCallback(), constructor(), createInstance(), enable(), event(), _handleThemeChange() (+11 more)
...
Cohesion: 0.24
Nodes (11): renderChatsList(), setMode(), setScreen(), toggleMode(), renderSettingsScreen(), ensureWebglAddon(), initResizeObserver(), initSubpixelScroll() (+3 more)
...
Cohesion: 0.18
Nodes (6): clearRange(), end(), put(), reset(), _start(), unhook()

### Community 39 - "Community 39"
Cohesion: 0.29
Nodes (12): openContactInfo(), renderSheetPanes(), AGENT_METADATA, closeRenameAgentDialog(), detectAgentKey(), formatBytes(), getAgentDefaultName(), getAgentIconSvg() (+4 more)
...
Cohesion: 0.14
Nodes (10): clearListeners(), delete(), dispose(), forEachByKey(), getKeyIterator(), _handleBufferActivate(), _removeDecoration(), _removeMarkerFromLink() (+2 more)
...
Cohesion: 0.39
Nodes (6): renderTabs(), handleStateUpdate(), updateActiveAgentsBadge(), updateConfirmationBanner(), updateHeaderInfo(), updateTerminalContent()
...
Cohesion: 0.08
Nodes (14): activeProtocol(), clearAllMarkers(), debug(), fillViewportRows(), fire(), _handleScroll(), insert(), loadAddon() (+6 more)
